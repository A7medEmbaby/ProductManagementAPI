...
public class DeductStockHandler : IRequestHandler<DeductStockCommand, ProductResponse>
{
    private readonly IProductRepository _productRepository;

    public DeductStockHandler(IProductRepository productRepository)
    {
        _productRepository = productRepository;
    }

    public async Task<ProductResponse> Handle(DeductStockCommand request, CancellationToken cancellationToken)
    {
        // Get product
